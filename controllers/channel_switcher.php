...
return new class extends NirvanaController {
    ...
    public function onGet(&$yt, $request) {
        ...
        $response = Request::innertubeRequest("account/accounts_list", (object) [
            "requestType" => "ACCOUNTS_LIST_REQUEST_TYPE_CHANNEL_SWITCHER",
            "callCircumstance" => "SWITCHING_USERS_FULL"
        ]);
        $ytdata = json_decode($response);
        
        $channelsData = $ytdata->actions[0]->updateChannelSwitcherPageAction->page->channelSwitcherPageRenderer->contents ?? null;
        ...
        $yt->page = ChannelSwitcherModel::bake($channelsData, $switcher);
