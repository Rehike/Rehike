...
class YtSigninCore {
	...
	private $root;
	private string $testUrl = 'https://www.youtube.com/user/jawed/about?pbj=1';
	...
	function generateCache($update = false) {
		...
		if ($this->cacheExists) {
			unlink('cache/sc2.json');
		}
		$newCacheFile = fopen('cache/sc2.json', 'w');
	...
	function __construct() {
		...
		*/
		$this->cacheExists = file_exists('cache/sc2.json') ? true : false;
