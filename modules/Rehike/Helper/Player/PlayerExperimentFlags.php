<?php
namespace Rehike\Helper\Player;

/**
 * Manages Rehike player experiment flags.
 * 
 * @author Isabella Lulamoon <kawapure@gmail.com>
 * @author The Rehike Maintainers
 */
class PlayerExperimentFlags
{
    public array $flags = [];
    ...
    /**
     * Sets a player experiment flag in this list.
     */
    ...
    /**
     * Removes an experiment flag from this list.
     */
    ...
    public const DEFAULT_FLAGS = [
        // These flags must be set for us to be able to generate our own PO tokens,
        // which is what we do with src/webpo-client.
        "bg_st_hr" => "true",
        "html5_use_shared_owl_instance" => "true",
        "html5_web_po_token_disable_caching" => "true",
        ...
        "bg_vm_reinit_threshold" => "7200000",
        ...
        "disable_mdx_connection_in_mdx_module_for_music_web" => "true",
        "disable_new_pause_state3" => "true",
        "disable_rounding_ad_notify" => "true",
        "disable_simple_mixed_direction_formatted_strings" => "true",
        "disable_thumbnail_preloading" => "true",
        "embeds_enable_autoplayblocked_ping_fix" => "true",
        "embeds_enable_embed_module" => "true",
        "embeds_enable_iframe_apis_through_oneplatform" => "true",
        "embeds_enable_intersection_observer_v2" => "true",
        "embeds_enable_mobile_custom_controls" => "true",
        ...
        "h5_csi_seek_latency_action_sampling" => "0.1",
        "hfr_dropped_framerate_fallback_threshold" => "0",
        "html5_ad_timeout_ms" => "0",
        "html5_ads_preroll_lock_timeout_delay_ms" => "15000",
        "html5_allow_chromecast_opus" => "true",
        "html5_allow_missing_ad_duration_in_player_vars" => "true",
        "html5_allow_video_keyframe_without_audio" => "true",
        "html5_allowable_liveness_drift_chunks" => "2",
        "html5_always_serve_dash" => "true",
        "html5_attach_num_random_bytes_to_bandaid" => "0",
        "html5_attach_po_token_to_bandaid" => "true",
        ...
        "html5_cancel_presenting_in_loadVideo" => "true",
        "html5_check_ad_position_and_reset_on_new_ad_playback_csi" => "true",
        "html5_check_next_resource_for_retry_delay" => "true",
        "html5_check_segnum_discontinuity" => "true",
        "html5_clear_video_data_on_dispose" => "true",
        "html5_consistent_innertube_transport_service" => "true",
        ...
        "html5_delayed_retry_count" => "1",
        "html5_delayed_retry_delay_ms" => "5000",
        ...
        "html5_log_server_url_param" => "true",
        ...
        "html5_manifestless_unplugged" => "true",
        "html5_manifestless_vp9" => "true",
        "html5_manifestless_vp9_otf" => "true",
        "html5_match_codecs_for_gapless" => "true",
        ...
        "html5_mfl_extend_max_request_time" => "true",
        ...
        "html5_non_onesie_attach_po_token" => "true",
        "html5_nonblocking_media_capabilities" => "true",
        "html5_not_register_disposables_when_core_listens" => "true",
        "html5_not_vp9_supported_quality_cap" => "0",
        "html5_offline_av1_fallback" => "true",
        "html5_onesie_advance_redirector" => "true",
        "html5_onesie_compress_player_response" => "true",
        "html5_onesie_defer_onProgress" => "true",
        "html5_onesie_enable_server_side_badwidth_estimation" => "true",
        "html5_onesie_faster_string_decode" => "true",
        "html5_onesie_format_constraint" => "true",
        "html5_onesie_ignore_innertube_api_key" => "true",
        "html5_onesie_live_ttl_secs" => "8",
        "html5_onesie_media_bytes" => "true",
        "html5_onesie_only_send_clear_media" => "true",
        "html5_onesie_por" => "true",
        "html5_onesie_prewarm_interval_ms" => "0",
        "html5_onesie_prewarm_max_lact_ms" => "0",
        "html5_onesie_progress_timeout_ms" => "0",
        "html5_onesie_server_initial_format_selection" => "true",
        "html5_onesie_sticky_server_side" => "true",
        "html5_onesie_use_media_promise" => "true",
        ...
        "html5_performance_impact_profiling_timer_ms" => "0",
        ...
        "html5_populate_media_position_in_ad_break_request" => "true",
        ...
        "html5_recover_from_non_fatal_errors_in_player_bytes" => "true",
        ...
        "html5_reset_resource_on_redirector_failure" => "true",
        "html5_resource_bad_status_delay_scaling" => "1.5",
        "html5_resource_no_content_delay_scaling" => "0.0",
        ...
        "html5_send_layout_unscheduled_signal_for_externally_managed" => "true",
        "html5_server_stitched_dai_decorated_url_retry_limit" => "5",
        "html5_session_po_token_interval_time_ms" => "900000",
        "html5_set_ended_in_pfx_live" => "true",
        "html5_signature_reload_refactor" => "true",
        "html5_simplify_streaming_xhr" => "true",
        "html5_skip_slow_ad_delay_ms" => "15000",
        "html5_slow_start_no_media_source_delay_ms" => "0",
        "html5_slow_start_timeout_delay_ms" => "20000",
        "html5_stack_trace_limit" => "25",
        ...
        "html5_unstarted_buffering" => "true",
        "html5_update_representation_init_boxes" => "true",
        "html5_use_current_media_time_for_glrem_gllat" => "true",
        "html5_use_multitag_webm_tags_parser" => "true",
        "html5_user_intent_on_loading" => "true",
        ...
        "orchestration_use_cascading_delete" => "true",
        "pageid_as_header_web" => "true",
        "pes_aes_all" => "true",
        "pes_migrate_association_data" => "true",
        "playback_start_config_use_start_time" => "true",
        ...
        "player_underlay_min_player_width" => "768.0",
        "player_underlay_video_width_fraction" => "0.6",
        ...
        "streaming_data_emergency_itag_blacklist" => "[]",
        "suppress_error_204_logging" => "true",
        "tv_caption_performance_optimization" => "true",
        ...
        "use_flare_get_approved_stream_formats" => "true",
        ...
        "web_csi_notification_ad_fix" => "true",
        ...
        "web_new_autonav_countdown" => "false",
        ...
        "web_player_bigger_buttons_like_mobile" => "false",
        ...
        "web_player_i_see_captions" => "true",
        ...
        "web_player_no_force_gvi" => "true",
        "web_player_offline_state_logging" => "true",
        "web_player_orchestration" => "false",
        "web_player_response_playback_tracking_parsing" => "true",
        "web_player_seek_chapters_by_shortcut" => "false",
        "web_player_seek_loop_range_after_duration" => "true",
        ...
        "web_player_ssdai_hold_initial_qoe_ping_killswitch" => "true",
        "web_player_touch_mode_improvements" => "false",
        "web_player_transfer_timeout_threshold_ms" => "10800000",
        "web_player_unavailable_subtitles_button" => "true",
        "web_player_unset_default_csn_killswitch" => "true",
        ...
        "woffle_pause_video_download" => "true",
        "woffle_relinquish_lock_on_inactivity" => "true",
