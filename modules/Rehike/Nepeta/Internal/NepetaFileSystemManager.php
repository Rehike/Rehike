...
/**
 * Implements the Nepeta file system manager.
 * 
 * This is, for all intents and purposes, a complete copy of Rehike\FileSystem.
 * We use this because we don't want Nepeta to be dependent on this module as
 * Nepeta should be able to hook the file system manager.
 * 
 * @author Taniko Yamamoto <kirasicecreamm@gmail.com>
 * @author The Rehike Maintainers
 */
class NepetaFileSystemManager
{
    /**
