<?php
namespace Rehike\i18n\Internal\Lang;

use Rehike\Attributes\StaticClass;

use Rehike\i18n\i18n;

use Rehike\i18n\Internal\Lang\Culture\DateTimeApi;
use Rehike\i18n\Internal\Util\UriUtils;
...
class LanguageApi
{
    ...
    {
        return i18n::getRouter()->languageExists($langId);
    }
    ...
    {
        return i18n::getConfigApi()->getExceptionOnFailureState();
    }
    ...
    ): string
    {
        ...
        if (self::shouldExcept()) throw new Exception(sprintf(
    ...
    public static function formatDateTime(int $format, int $timestamp =0): string
    {
        ...
        if (self::shouldExcept())
            throw new Exception("Failed to format date time");
    ...
    ): string
    {
        ...
        if (self::shouldExcept())
            throw new Exception("Failed to format number.");
    ...
    {
        $cultureName = i18n::getConfigApi()->getCultureFileName();
